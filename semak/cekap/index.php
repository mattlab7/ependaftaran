...
<body>
	<center>
		...
		<h1>Semakan Pangkalan Data - 1 Cekap</h1>
		<div id="datatable">
			<?php
				require_once('../mysqli_connect.php');

				$query = "SELECT idMurid, namaMurid, kpMurid, alamat, penjagaMurid, namaPenjaga, telefonPenjaga FROM datamurid WHERE kelas = '1 Cekap'";
